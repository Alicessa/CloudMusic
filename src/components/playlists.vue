  ...
  <div class="playlists-container">
    ...
    <div class="tab-container">
      ...
      <div class="tab-content">
        <div class="items">
          <div class="item"  v-for="(item,index) in playList" :key="index"  @click="Musicdetails(item.id)">
            <div class="img-wrap">
              <div class="num-wrap">
                播放量:
...
export default {
 ...
 watch:{
  ...
  methods: {
    ...
    //顶部数据
     topData(){
      // await getTopPlaylist({limit:1,cat:this.tag}).then(res=>{ 
    ...
    // 歌单列表数据(抽离不出来，有数据改变时但是数已经开改变了)
  // async listData(){
  //   await getPalylist({ 
  //       limit:30,
  //      offset:(this.page-1)*10,
  //       cat:this.tag}).then(res=>{
